...
# Creating a window
window = glfw.create_window(1200, 720, "Window", None, None)
...
# Load image
image = Image.open("./girl-2.png")
image = image.transpose(Image.FLIP_TOP_BOTTOM)
img_data = image.convert("RGBA").tobytes()

# img_data = np.array(image.getdata(), np.uint8) <==  another way to get the raw image data
